...
var UserForm = /*#__PURE__*/function (_View_1$View) {
  ...
  function UserForm() {
    ...
    _this.onSetNameClick = function () {
      ...
      if (input) {
        // type guard - if element,then...if null - nothing
...
},{"./views/UserEdit":"src/views/UserEdit.ts","./models/User":"src/models/User.ts"}],"C:/Users/jmjma/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
